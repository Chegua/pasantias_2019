<?php
//como segundo parametro colocamos el manejador: pgsql (postgres) o mysql (mysql)
define ("MANEJADOR","mysql");
//como segundo parametro el nombre o ip del servidor de Bases de Datos
