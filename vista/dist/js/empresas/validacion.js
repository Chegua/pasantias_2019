...
// var tipo = document.getElementById("tipo").value;//capturo el valor
//
// 	if (tipo== null || tipo.length== 0 || /^\s+$/.test(tipo)){//si esta vacio
// 		$('#tipo').parent().attr("class", "form-group col-md-2 has-error has-feedback");
// 		$("#tipo").parent().children("span.help-block").text("(Seleccione por favor.)").hide();
// 		$("#tipo").focus();
...
//
//
// 	if ( filtrotipo(document.getElementById("tipo").value)=='') { //si esta vacio
// 		$("#tipo").parent().attr("class","form-group col-md-2 has-error has-feedback");
// 		$("#tipo").parent().children("span.help-block").text("(Seleccione por favor.)").hide();
// 		$("#tipo").focus();
// 		//$('#tipo').parent().append('<span id="icon_tipo" class="glyphicon glyphicon-remove form-control-feedback"></span>');
...
// 	else{
// 	    $('#icon_tipo').remove();
// 		$("#tipo").parent().attr("class","form-group col-md-2  has-feedback");
// 		$("#tipo").parent().children("span").text("(¡Listo!)").hide();
