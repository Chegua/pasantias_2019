 ...
 <form action="../../../controlador/c_cargo.php" method="get">
    <div class="box box-warning">
       <div class="box-header with-border">
           <h3 class="" align="center"><i class="fa fa-edit"></i> <strong>Modificar cargo.</strong></h3>
      ...
      <div class="form-group">
                ...
                <option value="">Seleccione..</option>
                   <?php  
                     for ($i=0; $i<count($resultado2) ; $i++){?>
                      <option value="<?php echo $resultado2[$i]['id_tipo_cargo']?>" 
                        <?php if ($resultado2[$i]['id_tipo_cargo'] == $resultado[0]['id_tipo_cargo']){
                              echo "selected"; ?>
                      <?php } ?>><?php echo $resultado2[$i]['tipo_cargo']?>
                      </option>
                   <?php } ?>  
                   </select>
          ...
          <div class="col-md-5">  
              <label for="cargo">Cargo:</label>
               ...
               <input type="text" name="cargo" id="cargo" class="form-control" value="<?php echo $resultado[0]['cargo']; ?>" autocomplete="off">
