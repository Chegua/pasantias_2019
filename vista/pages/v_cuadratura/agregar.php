    ...
    <article class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-xs-12 col-md-offset-">
        ...
        <div class="form-row">
           ...
           <label for="anio">Año:  </label>
             <select class="form-control" name="anio" required>
               ...
               <?php for ($i=0; $i < count($resultado); $i++): ?>
                 <option value="<?php echo $resultado[$i]['id_anio'];?>"> <?php echo $resultado[$i]['anio']; ?></option>
               <?php endfor; ?>
          ...
          <div class="form-group col-md-4">
           ...
           <input type="hidden" name="periodo" value="<?php echo $resultado3['id_periodo']; ?>">

           <div class="form-group col-md-4">
            <label for="mostrar_periodo">Periodo escolar:  </label>
              <input type="text" name="mostrar_periodo" value="<?php echo $resultado3['periodo']; ?>" class="form-control" disabled>
            </div>

            <div class="col-md-12">
              <label for="">Docente Guia:</label>
              <button type="button" name="docente" class="btn btn-primary" data-toggle="modal" data-target="#modal_doc"><i class="fa fa-user-plus"></i> </button>
            </div>
            ...
            <div class="form-group col-md-4">
              ...
              <input type="text" name="cedulaD" id="cedulaD" class="form-control" readonly required>
            </div>
            <div class="form-group col-md-4">
              <label for="nombreD">Nombre:</label>
              <input type="text" name="nombreD" id="nombreD" class="form-control" readonly required>
            </div>
            <div class="form-group col-md-4">
              <label for="apellidoD">Apellido</label>
              <input type="text" name="apellidoD" id="apellidoD" class="form-control" readonly required>
            </div>
...
<div class="modal fade bs-example-modal-lg" id="modal_doc" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                ...
                <tbody>
                  <?php for ($i=0; $i < count($resultado4) ; $i++):?>
                    <tr>
                      ...
                      <td><button type="button" name="selecionar_docente" class="btn btn-sm btn-success" data-dismiss="modal" onclick="elegir_docente(<?php echo $resultado4[$i]['id_docente']?>);" ><i class="fa fa-check-square-o"></i> </button> </td>
