  ...
  <?php include ("../include/periodo.php"); ?>
    ...
    <div class="box box-warning">
       <div class="box-header with-border">
           <h3 class="" align="center"><strong><i class="fa fa-server"></i>   Departamentos.</strong></h3>
          ...
          <div class="panel-body">
            <table class="table table-hover table-bordered" id="example">
              ...
              <thead>
                ...
                <th class="col-md-5">Departamentos</th>
              ...
              <tbody>
                   <?php for ($i=0; $i <count($resultado) ; $i++): ?>
                    ...
                    <a href="javascript:preguntar(<?php echo $resultado[$i]['id_departamento']?>,'eliminar')" class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></a>
                      </td>
                    </tr>
                  <?php endfor; ?>
              </tbody>
