    ...
    <article class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-xs-12 col-md-offset-">
        ...
        <div class="form-row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" value="<?php echo $resultado1->rif;?>" name="rif" id="rif" class="form-control form-control-sm" placeholder="Ingrese el rif" autocomplete="off"
        ...
        <table class="table table-bordered" id="">
          ...
          <tbody id="filtrar"></tbody>
             ...
             <div class="form-group col-md-6">
                ...
                <input type="text" value="<?php echo $resultado1->telefono;?>" name="telefono" id="telefono" class="form-control form-control-sm" placeholder="Ingrese el numero" data-inputmask='"mask": "(9999) 999-9999"' data-mask autocomplete="off" maxlength="15">
              <span class="help-block">(Opcional.)</span>
             </div>

              <div class="form-group col-md-6">
                <label for="correo">Correo:</label>
                <input type="text" value="<?php echo $resultado1->correo;?>" name="correo" id="correo" class="form-control form-control-sm" placeholder="Ingrese el correo"  autocomplete="off">
              <span class="help-block">(Opcional.)</span>
              </div>
