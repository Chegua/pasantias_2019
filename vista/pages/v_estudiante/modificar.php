...
$mostrar= estudiantes::encontrar($id);
    ...
    <article class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-xs-12 col-md-offset-">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
              <label for="cedula">Cedula: </label>
                <div class="input-group">
                  ...
                  <input type="text" required class="form-control" name="cedula" id="cedula" autocomplete="off"  value="<?php echo $mostrar['cedula_estudiante'] ?>" placeholder="Ingrese la cedula" maxlength="8"  data-inputmask='"mask": "99999999"' data-mask>
            ...
            <div class="form-group col-md-6">
                  ...
                  <input type="text" name="nombre" value="<?php echo $mostrar['nombre_estudiante']; ?>" id="nombre" class="form-control form-control-sm" placeholder="Ingrese el nombre" autocomplete="off" required>
                  <span class="help-block"></span>
            </div>

             <div class="form-group col-md-6">
                  <label for="apellido">Apellidos: </label>
                  <input type="text" name="apellido" value="<?php echo $mostrar['apellido_estudiante']; ?>" id="apellido" class="form-control form-control-sm" placeholder="Ingrese el apellido" autocomplete="off" required>
                 <span class="help-block"></span>
            </div>

            <div class="form-group col-md-4">
              <label for="sexo">Sexo: *</label><br>
              <?php if ($mostrar['sexo_estudiante']=='Masculino'):?>
              ...
              <?php elseif ($mostrar['sexo_estudiante']=='Femenino'):?>
         ...
         <div class="form-group col-md-6">
           ...
           <input type="date" name="fecha_nacimiento" value="<?php echo $mostrar['fecha_nacimiento']; ?>"id="fecha_nacimiento" class="form-control form-control-sm" required>
        </div>

        <div class="form-group col-md-2">
          <label for="edad">Edad</label>
          <input type="int" name="edad" value="<?php echo $mostrar['edad']; ?>" id="edadCalculada" class="form-control form-control-sm" readonly>
        </div>

          <div class="form-group col-md-6">
              <label for="telefono">Telefono:</label>
              <input type="text" name="telefono" value="<?php echo $mostrar['telefono_estudiante'] ?>" id="telefono" class="form-control form-control-sm" placeholder="Ingrese el numero" data-inputmask='"mask": "(9999) 999-9999"' data-mask autocomplete="off" maxlength="15">
          </div>

          <div class="form-group col-md-6">
                <label for="correo">Correo:</label>
                <input type="text" name="correo" value="<?php echo $mostrar['correo_estudiante'] ?>" id="correo" class="form-control form-control-sm" placeholder="Ingrese el correo"  autocomplete="off">
               <span class="help-block"></span>
          </div>
          ...
          <div class="form-group col-md-3">
            ...
            <input type="text" name="cedulaR" value="<?php echo $mostrar['cedula_representante'] ?>" id="cedulaR" class="form-control" disabled>
          </div>
          <div class="form-group col-md-3">
            <label for="nombreR">Nombre:</label>
            <input type="text" name="nombreR" value="<?php echo $mostrar['nombre_representante']; ?>" id="nombreR" class="form-control" disabled>
          </div>
          <div class="form-group col-md-3">
            <label for="apellidoR">Apellido:</label>
            <input type="text" name="apellidoR" value="<?php echo $mostrar['apellido_representante'] ?>" id="apellidoR" class="form-control" disabled>
          </div>

          <div class="form-group col-md-3">
            <label for="parentesco">Parentesco:</label>
            <select class="form-control" name="parentesco" id="parentesco">
              <option value=""><?php echo $mostrar['nombre_representante']; ?></option>
          ...
          <div class="form-group col-md-4">
            ...
            <input type="text" name="anio" value="<?php echo $mostrar['anio']; ?>" id="anio" class="form-control" disabled>
          </div>
          <div class="form-group col-md-4">
            <label for="mencion">Mencion:</label>
            <input type="text" name="mencion" value="<?php echo $mostrar['mencion']; ?>" id="mencion" class="form-control" disabled>
          </div>
          <div class="form-group col-md-4">
            <label for="periodo">Periodo escolar:</label>
            <input type="text" name="periodo" value="<?php echo $mostrar['periodo']; ?>" id="periodo" class="form-control" disabled>
          </div>
          ...
          <div class="form-group col-md-4">
            ...
            <input type="text" name="cedulaD" value="<?php echo $mostrar['cedula_docente']; ?>" id="cedulaD" class="form-control" disabled>
          </div>
          <div class="form-group col-md-4">
            <label for="nombreD">Nombre:</label>
            <input type="text" name="nombreD" value="<?php echo $mostrar['nombre_docente']; ?>" id="nombreD" class="form-control" disabled>
          </div>
          <div class="form-group col-md-4">
            <label for="apellidoD">Apellido:</label>
            <input type="text" name="apellidoD" value="<?php echo $mostrar['apellido_docente']; ?>" id="apellidoD" class="form-control" disabled>
          </div>
