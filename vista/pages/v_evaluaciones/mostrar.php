                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><button title="Modificar Registro" type="button"
                                                    onClick="window.location.href='modificar.php<?php echo '?id='?><?php echo $resultado[$i]['id_evaluacion']?>'"
                                                    class="btn btn-sm btn-warning"><span
                                                        class="glyphicon glyphicon-pencil"></span></button>

                                                <a href="javascript:preguntar(<?php echo $resultado[$i]['id_evaluacion']?>,'eliminar')"
