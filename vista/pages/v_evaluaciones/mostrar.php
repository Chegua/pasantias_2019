...
require_once("../../../modelo/m_evaluacion.php");
  ...
  $resultado = $evaluacion->consultar();
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-pencil"></i> Evaluaciones.
          ...
          <div class="panel-body">
            <table class="table table-hover table-bordered" id="example">
              ...
              <thead>
                ...
                <th class="col-md-3">Nombre evaluacion</th>
              ...
              <tbody>
                   <?php for ($i=0; $i <count($resultado) ; $i++): ?>
                    <tr>
                      <td> <?php echo $i+1; ?></td>
                      <td><?php echo $resultado[$i]['nombre_evaluacion']; ?></td>
                      <td><?php echo $resultado[$i]['tipo_evaluacion']; ?></td>
                      <td><?php echo $resultado[$i]['porcentaje']; ?></td>

                      <td class="text-center"><button title="Modificar Registro" type="button" onClick="window.location.href='modificar.php<?php echo '?id='?><?php echo $resultado[$i]['id_departamento']?>'" class="btn btn-sm btn-warning"><span class="glyphicon glyphicon-pencil"></span></button>

                    <a href="javascript:preguntar(<?php echo $resultado[$i]['id_evaluacion']?>,'eliminar')" class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></a>
                      </td>
                    </tr>
                  <?php endfor; ?>
              </tbody>
...
<!-- ./wrapper -->
 ...
 <script src="../../dist/toastr-master/build/toastr.min.js"></script>
  ...
  <script src="../../dist/js/evaluaciones/eliminar2.js"></script>
