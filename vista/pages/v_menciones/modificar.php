 ...
 <form action="../../../controlador/c_mencion.php" method="get">
    <div class="box box-warning">
       <div class="box-header with-border">
           <h3 class="" align="center"><i class="fa fa-edit"></i> <strong>Modificar mencion.</strong></h3>
        ...
        <div class="form-group ">
          <div class="col-md-10 col-md-offset-1">       
              <label for="mencion">Mencion:</label>
               <input type="text" name="mencion" id="mencion" value="<?php  echo $resultado[0]['mencion'] ?>" class="form-control" autocomplete="off">
