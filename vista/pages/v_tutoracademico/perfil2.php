...
if (isset($_SESSION['user_id'])) {    
  ...
  $resultado=historial_academico::encontrar2($id);
 ?>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-graduation-cap"></i> Tutor Academico.
    ...
    <section class="content">
      ...
      <div class="box box-warning">
        <div class="box-header with-border">
          <h3 class="box-title">Datos como tutor: </h3>           <div class="pull-right hidden-xs">
...
<article class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-xs-12 col-md-offset-">
       ...
       <div class="form-group col-md-6">
          ...
          <div class="form-group col-md-6">
              ...
              <?php echo $resultado[0]['estatus_tutor']; ?>
         </div>

         <div class="form-group col-md-6">
              <label for="fecha inicio">Fecha inicio:</label>
              <?php echo $resultado[0]['fecha_inicio_t']; ?>
         </div>

         <div class="form-group col-md-6">
              <label for="fecha inicio">Fecha final:</label>
              <?php echo $resultado[0]['fecha_fin_t']; ?>
         </div>
